...
# Lower --confidence increases recall and can recover more missed frames.
python extract_silhouettes.py --video_dir data/videos --output_dir data/silhouettes --boundary_points 128 --model yolov8m-seg.pt --confidence 0.25 --device cuda
...
python train.py --dataset HMDB --data_dir data/point_clouds --n_classes 2 --epochs 100 --batch_size 128 --output_dir checkpoints/scn
...
- [ ] Test with different temporal window
- [ ] Test with different silhouttes confidence
- [ ] Silhouttes preview/demo-able extracted videos
- [ ] Try lower confidence (0.15-0.25) if recall is still poor
